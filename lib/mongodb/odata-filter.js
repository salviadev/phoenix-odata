"use strict";
const index_1 = require('../odata/index');
...
function $having2mongoFilter(filter, options) {
    let res = {};
    let gids = (options && options.group) ? Object.keys(options.group) : null;
    var p = index_1.OdataParser.parse(filter, null, function (idToken) {
...
exports.$having2mongoFilter = $having2mongoFilter;
